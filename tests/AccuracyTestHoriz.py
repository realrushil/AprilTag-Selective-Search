...
def corners_to_position(a, b, c, d):
  ...
  #cv2.putText(frame, str(non), (50, 300), font, 1, (0, 255, 255), 2, cv2.LINE_AA)
  if (non > 0):
    #cv2.putText(frame, str(Tag.get_position()[4]), (50, 200), font, 1, (0, 255, 255), 2, cv2.LINE_AA)
    #cv2.putText(frame, str(angles[1]), (50, 250), font, 1, (0, 255, 0), 2, cv2.LINE_AA)
    if (abs(angles[0] - Tag.get_position()[3]) > 10):
        #cv2.putText(frame, str(backupPos[4]), (50, 100), font, 1, (255, 0, 0), 2, cv2.LINE_AA)
        return Tag.get_position()
    elif (abs(angles[1] - Tag.get_position()[4]) > 10):
        #cv2.putText(frame, str(backupPos[4]), (50, 100), font, 1, (255, 0, 0), 2, cv2.LINE_AA)
        return Tag.get_position()
    else:
        #cv2.putText(frame, str(angles[1]), (50, 100), font, 1, (255, 0, 0), 2, cv2.LINE_AA)
    ...
    for i in range(0, 6):
        ...
        for j in range(1, 4):
            ...
            while True:
                ...
                #cv2.line(frame, adjC, adjD, (255, 255, 255), 4)
                #cv2.line(frame, adjD, adjA, (255, 255, 255), 4)
                #cv2.line(frame, preA, preB, (255, 255, 255), 4)
                #cv2.line(frame, preB, preC, (255, 255, 255), 4)
                #cv2.line(frame, preC, preD, (255, 255, 255), 4)
                #cv2.line(frame, preD, preA, (255, 255, 255), 4)
